...
class NestedCoordinatorLayout2 @JvmOverloads constructor(
        context: Context,
    ...
    override fun startNestedScroll(axes: Int) = helper.startNestedScroll(axes)
    ...
    override fun dispatchNestedScroll(
            ...
            type: Int
    ) = helper.dispatchNestedScroll(dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed, offsetInWindow, type)
