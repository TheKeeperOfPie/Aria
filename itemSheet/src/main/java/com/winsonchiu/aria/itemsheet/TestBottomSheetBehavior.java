 ...
 * bottom sheet.
 */
public class TestBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public TestBottomSheetBehavior() {}
     ...
     */
    public TestBottomSheetBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private final ViewDragHelper.Callback mDragCallback =
            new ViewDragHelper.Callback() {
                ...
                public int clampViewPositionVertical(View child, int top, int dy) {
                    return Math.min(Math.max(mMinOffset, top), mHideable ? mParentHeight : mMaxOffset);
                }
    ...
    /**
     * A utility function to get the {@link TestBottomSheetBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link TestBottomSheetBehavior}.
     * @return The {@link TestBottomSheetBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> TestBottomSheetBehavior<V> from(V view) {
        ViewGroup.LayoutParams params = view.getLayoutParams();
        if (!(params instanceof CoordinatorLayout.LayoutParams)) {
            throw new IllegalArgumentException("The view is not a child of CoordinatorLayout");
        }
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params).getBehavior();
        if (!(behavior instanceof TestBottomSheetBehavior)) {
            throw new IllegalArgumentException("The view is not associated with TestBottomSheetBehavior");
        }
        return (TestBottomSheetBehavior<V>) behavior;
    }
}