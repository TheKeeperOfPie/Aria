...
class MediaNotificationManager(
    ...
    @Inject
    lateinit var delegate: MediaDelegate
    ...
    init {
        (service.applicationContext.getSystemService(DaggerConstants.APPLICATION_COMPONENT) as MediaInjector).inject(this)
    }
    ...
    fun buildNotification(
        ...
        return NotificationCompat.Builder(service,
                ...
                .setContentIntent(delegate.notificationContentIntent(service))
